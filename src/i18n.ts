...
export const strings = {
  en: {
    ...
    // Notices
    noticeReminderDue: "Sift: {count} card(s) due. Click to review.",
    noticeNoCardsDue: "Sift: no cards due.",
    noticeNoCardsDueInDeck: "Sift: no cards due in {deck}.",
    noticeStillIndexing: "Sift: still indexing, try again in a moment.",
    noticeProgressReset: "Sift: all learning progress has been reset.",
    // ReviewModal
  ...
  de: {
    ...
    noticeReminderDue: "Sift: {count} Karte(n) fällig. Klicken zum Lernen.",
    noticeNoCardsDue: "Sift: Keine Karten fällig.",
    noticeNoCardsDueInDeck: "Sift: Keine Karten fällig in {deck}.",
    noticeStillIndexing: "Sift: Wird noch indexiert, bitte gleich erneut versuchen.",
    noticeProgressReset: "Sift: Der gesamte Lernfortschritt wurde zurückgesetzt.",
    ...
    close: "Schließen",
    decksViewTitle: "Sift-Kartenstapel",
